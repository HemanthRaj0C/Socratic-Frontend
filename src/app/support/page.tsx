  ...
  const paymentOptions = [
    {
      ...
      amount: '₹99',
      icon: <Coffee className="w-6 h-6 md:w-8 md:h-8 text-yellow-400" />,
    ...
    },
    {
      ...
      amount: '₹499',
      icon: <Heart className="w-6 h-6 md:w-8 md:h-8 text-pink-400" />,
    ...
    },
    {
      ...
      amount: '₹1999',
      icon: <Star className="w-6 h-6 md:w-8 md:h-8 text-blue-400" />,
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-8 md:mb-12">
            ...
            <BlurText 
              ...
              className="text-2xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-pink-400 to-blue-400 bg-clip-text text-transparent"
              delay={50}
            />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-8 md:mb-12">
            {paymentOptions.map((option) => (
              <SpotlightCard 
                key={option.id}
                className={`bg-gradient-to-br ${option.gradient} ${option.border} p-4 md:p-6 rounded-xl backdrop-blur-sm hover:scale-105 transition-all duration-300`}
                ...
                <div className="text-center">
                  ...
                  <div className="mb-4 md:mb-6">
                    <img 
                      ...
                      className={`w-32 h-32 md:w-40 md:h-40 mx-auto rounded-lg border-2 ${option.border}`}
                    />
                  </div>
                  ...
                  <h3 className="text-xl md:text-2xl font-bold text-white mb-2">{option.title}</h3>
                  <p className={`${option.textColor} text-xs md:text-sm mb-3 md:mb-4`}>{option.description}</p>
                  <p className="text-2xl md:text-3xl font-bold text-white mb-4 md:mb-6">{option.amount}</p>

                  {/* Payment Methods */}
                  <div className="space-y-2 md:space-y-3">
                    {/* QR Code Payment */}
                    <div className={`bg-black/30 p-2 md:p-3 rounded-lg border ${option.border}`}>
                      <div className="flex items-center justify-center space-x-2">
                        <QrCode className="w-4 h-4 md:w-5 md:h-5 text-gray-300" />
                        <span className="text-xs md:text-sm text-gray-300">Scan QR Code</span>
                      </div>
                    </div>
                    ...
                    <a 
                      ...
                      className={`block bg-gradient-to-r from-slate-700 via-gray-700 to-slate-700 hover:from-slate-600 hover:via-gray-600 hover:to-slate-600  border-slate-600 p-2 md:p-3 rounded-lg transition-all duration-300 transform hover:scale-105`}
                    >
                      <div className="flex items-center justify-center space-x-2">
                        <CreditCard className="w-4 h-4 md:w-5 md:h-5 text-white" />
                        <span className="text-xs md:text-sm text-white font-semibold">Pay with Razorpay</span>
                  ...
                  {/* Note */}
                  <p className={`${option.textColor} text-xs mt-3 md:mt-4 opacity-75`}>
          ...
          <div className="text-center mb-8 md:mb-12">
            <div className="bg-black/30 backdrop-blur-sm rounded-xl p-4 md:p-8 border border-white/10">
          ...
          <div className="text-center">
            <BlurText 
              ...
              delay={50}
            />
            <div className="bg-gradient-to-r from-pink-900/30 to-blue-900/30 p-4 md:p-6 rounded-xl border border-pink-400/30">
