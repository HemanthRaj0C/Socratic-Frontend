    ...
    return (
        <div className="w-full h-full relative text-white">
            ...
            <div className="relative z-10 flex flex-col h-full">
                {/* Enhanced Header */}
                <header className="relative flex-shrink-0 my-4 md:my-7 px-4 md:px-0 pt-16 md:pt-0">
                        ...
                        <div className="flex items-center space-x-2 md:space-x-4">
                            ...
                            <div>
                                <h1 className="text-lg md:text-xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent flex items-center space-x-2">
                                    ...
                                    <span className="hidden sm:inline">New Socratic Session</span>
                                    <span className="sm:hidden">New Session</span>
                                </h1>
                                <p className="text-xs md:text-sm text-gray-400">Start your learning journey</p>
                            </div>
                        </div>
                        ...
                        {messages.length === 0 && !isLoading ? (
                            <div className="text-center px-4">
                                <div className="flex justify-center mb-4 md:mb-6">
                                    <HelpCircle className="w-16 h-16 md:w-20 md:h-20 text-blue-400" />
                                </div>
                                ...
                                <p className="text-gray-400 mb-8 md:mb-12 max-w-2xl mx-auto text-base md:text-lg">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 max-w-4xl mx-auto mb-8 md:mb-12">
                                    <div className="group p-4 md:p-6 bg-white/5 hover:bg-white/10 backdrop-blur-sm rounded-xl border border-white/10 hover:border-blue-500/30 transition-all duration-300 cursor-pointer"
                                         onClick={() => setInput("What is the nature of knowledge?")}>
                                        <div className="flex justify-center mb-2 md:mb-3">
                                            <Brain className="w-6 h-6 md:w-8 md:h-8 text-blue-400" />
                                        </div>
                                        <h3 className="font-semibold mb-2 text-blue-400 text-sm md:text-base">Philosophy</h3>
                                        <p className="text-xs md:text-sm text-gray-400">Explore deep questions about existence, knowledge, and meaning</p>
                                    </div>
                                    
                                    <div className="group p-4 md:p-6 bg-white/5 hover:bg-white/10 backdrop-blur-sm rounded-xl border border-white/10 hover:border-purple-500/30 transition-all duration-300 cursor-pointer"
                                         onClick={() => setInput("How does quantum mechanics work?")}>
                                        <div className="flex justify-center mb-2 md:mb-3">
                                            <Microscope className="w-6 h-6 md:w-8 md:h-8 text-purple-400" />
                                        </div>
                                        <h3 className="font-semibold mb-2 text-purple-400 text-sm md:text-base">Science</h3>
                                        <p className="text-xs md:text-sm text-gray-400">Understand natural phenomena through inquiry and discovery</p>
                                    </div>
                                    
                                    <div className="group p-4 md:p-6 bg-white/5 hover:bg-white/10 backdrop-blur-sm rounded-xl border border-white/10 hover:border-pink-500/30 transition-all duration-300 cursor-pointer"
                                         onClick={() => setInput("What is the impact of AI on society?")}>
                                        <div className="flex justify-center mb-2 md:mb-3">
                                            <Laptop className="w-6 h-6 md:w-8 md:h-8 text-pink-400" />
                                        </div>
                                        <h3 className="font-semibold mb-2 text-pink-400 text-sm md:text-base">Technology</h3>
                                        <p className="text-xs md:text-sm text-gray-400">Learn about innovation, algorithms, and digital transformation</p>
                                    </div>
                                </div>    
                            </div>
                        ) : (
                ...
                {/* Enhanced Input Area */}
                <footer className="relative p-3 md:p-6 backdrop-blur-sm bg-black/20 border-t border-white/10 flex-shrink-0">
